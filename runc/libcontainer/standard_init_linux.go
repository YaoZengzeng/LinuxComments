...
func (l *linuxStandardInit) Init() error {
	...
	// 如果配置了新的mount namespace，则调用prepareRootfs
	...
	// they wanted.
	// 配置console，这必须在我们finalize rootfs之前完成，但是需要在让所有用户配置的mount都完成
	// 之后
	...
	// write to a socket.
	// 告诉parent我们已经准备Execv了，这需要在Seccomp rule生效前完成，因为我们需要能够读写
	// socket
