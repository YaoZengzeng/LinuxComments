...
// prepareRootfs设置新的mount namespace里的devices，mount points以及文件系统
// 并且它不会将任何事设置只读。我们必须在这个函数之后调用finalizeRootfs来结束rootfs的设置
...
// writeSystemProperty根据key将value写入/proc/sys之下的路径
// 比如net.ipv4.ip_forward将被转换为/proc/sys/net/ipv4/ip_forward
