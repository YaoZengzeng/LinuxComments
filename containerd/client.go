...
// address默认为/run/containerd/containerd.sock
func New(address string, opts ...ClientOpt) (*Client, error) {
	// clientOpts只包含defaultns和dialOptions两个字段
...
// NewWithConn返回一个新的containerd client
...
func (c *Client) NewContainer(ctx context.Context, id string, opts ...NewContainerOpts) (Container, error) {
	...
	// ContainerService返回containers.Store
